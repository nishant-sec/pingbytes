---
title: "How People Are Making $10,000/Month on YouTube Without Showing Their Face (Complete 2025 Blueprint) and it was really"
...
1. Install the Giscus GitHub App on your repo and create a discussion category
2. Add to `.env`:
   ```bash
