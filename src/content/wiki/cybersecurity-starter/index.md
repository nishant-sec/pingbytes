...
### What’s inside
- `labs/lab-setup` — Build a small home lab with VMs and safe targets.
- `incident-response/playbook-basics` — Minimal steps for handling alerts.

## Learning goals
- Practice investigation without breaking prod.
- Capture evidence cleanly.
- Communicate clearly and briefly.

## Core habits
1. Time-stamp everything you do.
