...
- Verify alerts and dashboards you’re watching.

## During the call
- Share the current timeline, owners, and severity.
- Confirm the next responder has access to logs, runbooks, and dashboards.
- Agree on the next check-in time.
